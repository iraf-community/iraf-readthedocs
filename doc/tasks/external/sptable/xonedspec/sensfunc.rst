...
.. raw:: html
  ...
  the standard extinction tables and are, thus, interchangable.  If no
  ...
  interactively with the colon command <span style="font-family: monospace;">":graphs <i>types</i><span style="font-family: monospace;">".  The ability
  ...
  <span style="font-family: monospace;">":marks <i>types</i><span style="font-family: monospace;">" also let the user define the symbols used to mark
