...
.. raw:: html
  ...
  change; for example rebinning to logrithmic wavelengths will produce flux
  ...
  and shifts are transfered from the database to the world coordinate system
  ...
  spectra will be resampled to to linear sampling.
  </p>
  <p>
  ...
  of the input spectrum are set to zero.  The default interpolation function
