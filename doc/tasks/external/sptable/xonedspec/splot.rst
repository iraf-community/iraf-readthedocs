...
.. raw:: html
  ...
  core intensity, flux above or below the continuum, and the equivalent width.
  </dd>
  </dl>
  <dl id="l_f">
  <dt><b>f</b></dt>
  ...
  interative rejection is used to exclude spectra lines from the fit
  ...
  but there is a measureable doppler shift.
  </p>
  <p>
  ...
  the two-sided measurments use the full-width.
  </p>
  <p>
  ...
  To get the full output and the output from previous measurments use the
  ...
  plotted scale.  It is the user's responsiblity to keep track of the flux
