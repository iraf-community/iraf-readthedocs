...
darkcombine: Combine and process mosaic dark count exposures
============================================================
...
.. raw:: html
  ...
  <dl id="l_output">
  <dt><b>output = <span style="font-family: monospace;">"Dark"</span></b></dt>
  ...
  <dl id="l_ccdtype">
  <dt><b>ccdtype = <span style="font-family: monospace;">"dark"</span></b></dt>
  ...
  <dl id="l_scale">
  <dt><b>scale = <span style="font-family: monospace;">"exposure"</span> (none|mode|median|mean|exposure)</b></dt>
