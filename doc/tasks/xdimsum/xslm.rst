...
.. raw:: html
  ...
  <dl id="l_ssmasks">
  <dt><b>ssmasks = <span style="font-family: monospace;">".ssm"</span></b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='ssmasks' Line='ssmasks = ".ssm"' -->
  <dd>The list of output sky subtraction masks or the string appended to the output
  ...
  <dl id="l_del_ssmasks">
  <dt><b>del_ssmasks = yes</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='del_ssmasks' Line='del_ssmasks = yes' -->
  <dd>Delete the sky subtraction masks at task termination ?
  </dd>
  </dl>
  <dl id="l_del_hmasks">
  ...
  input image pixel masks <i>ssmasks</i> and a list of holes masks
  <i>hmasks</i>.
  </p>
  <p>
  ...
  masks <i>ssmasks</i>. Each pixel of the sky subtraction pixel is
  ...
  mask <i>hmasks</i> is created. The holes masks are used by the XNREGISTAR task
  to create the combined final image.
  </p>
  <p>
  If <i>del_ssmasks</i> and <i>del_hmasks</i> then the sky subtraction  and
