...
.. raw:: html
  ...
  <dl>
  <dt><b>=9 Single line report with line offset in Angstroms for each emission line</b></dt>
  <!-- Sec='PARAMETERS' Level=1 Label='' Line='=9 Single line report with line offset in Angstroms for each emission line' -->
  <dd></dd>
  </dl>
  <dl>
  <dt><b>=10  One line per spectrum, with combined, cross-correlation, and</b></dt>
  <!-- Sec='PARAMETERS' Level=1 Label='' Line='=10  One line per spectrum, with combined, cross-correlation, and' -->
  <dd>emission line velocities, number of lines found and fit, and a list of
  names and wavelengths of the lines which were used in the fit, without
  equivalent width error.
  </dd>
  </dl>
  <dl>
  <dt><b>=11 Single line report with line offset in pixels for each emission line</b></dt>
  <!-- Sec='PARAMETERS' Level=1 Label='' Line='=11 Single line report with line offset in pixels for each emission line' -->
  <dd></dd>
  </dl>
  </dd>
  </dl>
  ...
  <dl id="l_nlfit">
  <dt><b>nlfit = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='nlfit' Line='nlfit = 0' -->
  <dd>Number of emission lines found and fit
  </dd>
  </dl>
  <dl id="l_emline">
  <dt><b>emline = <span style="font-family: monospace;">""</span></b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='emline' Line='emline = ""' -->
  <dd>Name of first emission line
  </dd>
  </dl>
  <dl id="l_wlrest">
  <dt><b>wlrest = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='wlrest' Line='wlrest = 0' -->
  <dd>Rest wavelength of first emission line
  </dd>
  </dl>
  <dl id="l_velocity">
  <dt><b>velocity = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='velocity' Line='velocity = 0' -->
  <dd>Velocity for all emission lines
  </dd>
  </dl>
  <dl id="l_velerr">
  <dt><b>velerr = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='velerr' Line='velerr = 0' -->
  <dd>Velocity error for all emission lines
  </dd>
  </dl>
  <dl id="l_lineheight">
  <dt><b>lineheight = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='lineheight' Line='lineheight = 0' -->
  <dd>Height of first emission line
  </dd>
  </dl>
  <dl id="l_linewidth">
  <dt><b>linewidth = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='linewidth' Line='linewidth = 0' -->
  <dd>Width of first emission line
  </dd>
  </dl>
  <dl id="l_lineeqw">
  <dt><b>lineeqw = 0</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='lineeqw' Line='lineeqw = 0' -->
  <dd>Equivalent width (or area, if continuum is less than <i>mincont</i>) of first emission line
  </dd>
  </dl>
  <dl id="l_meanvel">
  <dt><b>meanvel = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='meanvel' Line='meanvel = 0.' -->
  <dd>Mean velocity in km/sec
  </dd>
  </dl>
  <dl id="l_meanerr">
  <dt><b>meanerr = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='meanerr' Line='meanerr = 0.' -->
  <dd>Mean velocity error in km/sec
  </dd>
  </dl>
  <dl id="l_medvel">
  <dt><b>medvel = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='medvel' Line='medvel = 0.' -->
  <dd>Median velocity in km/sec
  </dd>
  </dl>
  <dl id="l_medq1">
  <dt><b>medq1 = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='medq1' Line='medq1 = 0.' -->
  <dd>First quartile velocity for multiple orders
  </dd>
  </dl>
  <dl id="l_medq2">
  <dt><b>medq2 = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='medq2' Line='medq2 = 0.' -->
  <dd>Second quartile velocity for multiple orders
  </dd>
  </dl>
  <dl id="l_meanpix">
  <dt><b>meanpix = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='meanpix' Line='meanpix = 0.' -->
  <dd>Mean pixel shift of first line 
  </dd>
  </dl>
  <dl id="l_medpix">
  <dt><b>medpix = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='medpix' Line='medpix = 0.' -->
  <dd>Median pixel shift of first line
  </dd>
  </dl>
  <dl id="l_meandwl">
  <dt><b>meandwl = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='meandwl' Line='meandwl = 0.' -->
  <dd>Mean wavelength shift of first line in Angstroms
  </dd>
  </dl>
  <dl id="l_meddwl">
  <dt><b>meddwl = 0.</b></dt>
  <!-- Sec='PARAMETERS' Level=0 Label='meddwl' Line='meddwl = 0.' -->
  <dd>Median wavelength shift of first line in Angstroms
  </dd>
  </dl>
  <dl id="l_obj_plot">
  ...
  <h3>Description</h3>
  <i>pemsao</i> finds emission lines, computes redshifts for each identified line,
  and combines them into a single radial velocity.  The results are written into
  the parameter file for this task and may also be
  ...
  http://tdc-www.harvard.edu/iraf/rvsao/pemsao
